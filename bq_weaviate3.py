...
collection_name = "Titan5Collection"
client = weaviate.connect_to_local(
    host="127.0.0.1",  # Use a string to specify the host
    port=8080,
    grpc_port=50051,
)
titan5 = client.collections.get(collection_name)
...
def insert_embedding_to_weaviate(collection_name, embedding, payload, vector_id=None):
